...
export const translations: Translations = {
  ...
  aspas: {
    ...
    confirmation: {
      title: '警告',
      message:
        "這將會移除 ASPA '{customer} => {providers}'. 是否繼續？",
      added: '已添加ASPA',
      retired: '已移除ASPA',
      retiredSuccess: '該ASPA已被移除',
      addedSuccess: '該ASPA已被添加',
      commentUpdatedSuccess: '該ASPA的備註已更新',
    },
    customer_validation_format: "客戶ASN格式無效或已存在",
    providers_validation_format: "供應商ASN格式無效",
  },
  announcements: {
