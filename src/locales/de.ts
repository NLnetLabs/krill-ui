...
export const translations: Translations = {
  ...
  'onboarding': {
    ...
    'welcomeHtml': 'Starten wir mit der Erstellung Ihrer RPKI Zertifizierungsstelle (CA). Diese wird zur Konfiguration von delegierter RPKI mit übergeordneten Zertifizierungsstellen benötigt. Im Normalfall ist dies Ihre Regionale oder Nationale Internet Registrierungsstelle.<br><br>Der von Ihnen gewählte Name wird zur Identifizierung Ihrer Zertifizierungsstelle gegenüber den über- und untergeordneten Zertifizierungsstellen genutzt. Der Name selbst wird nicht in der RPKI veröffentlicht. Bitte wählen Sie einen Namen, der es anderen erlaubt Ihre Organisation zu identifizieren. Dieser Name kann nachträglich nicht mehr geändert werden.',
    'addCAForm': {
      'required': 'Dies ist ein Pflichtfeld',
      'format': 'Ungültiger Name für eine Zertifizierungsstelle',
  ...
  'caDetails': {
    ...
    'parentsTab': {
      'request': 'Anfrage der untergeordneten Zertifizierungsstelle',
      'response': 'Antwort der übergeordneten Zertifizierungsstelle',
      'addParent': 'Eine zusätzliche übergeordnete Zertifizierungsstelle hinzufügen',
      'addParentSuccess': 'Übergeordnete Zertifizierungsstelle erfolgreich hinzugefügt',
      'name': 'Name der übergeordneten Zertifizierungsstelle',
      'namerequired': 'Ein Name für die übergeordnete Zertifizierungsstelle ist erforderlich',
    ...
    'syncParents': 'Synchronisiere mit übergeordneter Zertifizierungsstelle',
  ...
  'errors': {
    ...
    'ca_repo_response_wrong_xml': 'Antwort der übergeordneten Zertifizierungsstelle anstatt der Datenbank (Repository) erhalten',
    'ca_parent_duplicate': 'Es existiert bereits eine übergeordnete Zertifizierungsstelle mit dem Namen \'{parent}\'',
    ...
    'ca_child_resources_required': 'Sie müssen Ressourcen für die untergeordnete Zertifizierungsstelle angeben \'{child}\'',
