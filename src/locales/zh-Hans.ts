...
export const translations: Translations = {
  ...
  aspas: {
    ...
    confirmation: {
      title: '警告',
      message:
        "这将会移除 ASPA '{customer} => {providers}'. 是否继续？",
      added: 'ASPA 已添加',
      retired: 'ASPA 已移除',
      retiredSuccess: '该 ASPA 已被移除',
      addedSuccess: '该 ASPA 已被添加',
      commentUpdatedSuccess: '该 ASPA 的备注已更新',
    },
    customer_validation_format: "客户ASN格式无效或已存在",
    providers_validation_format: "提供商ASN格式无效",
  },
  announcements: {
