...
export const translations: Translations = {
  ...
  login: {
    ...
    copied:
      "You should not get your passwords from <a href='https://xkcd.com/936/' target='_blank'>https://xkcd.com/936/</a>",
    id: 'Username',
  ...
  caDetails: {
    ...
    refresh: 'Refreshing {handle}, this can take a while',
    ...
    confirmation: {
      title: 'Warning',
      message:
        "This will remove the ROA '{prefix}-{max_length} => {asn}'. Continue?",
      added: 'ROA added',
      retired: 'ROA removed',
    ...
    suggestions: {
      ...
      ourSuggestionHelp:
        'Our suggestion is based on RIPE RIS Routing information, please verify!',
      addThis: 'Add this',
      ...
      reasons: {
        ...
        disallowing:
          'This ROA disallows announcements only. If this is intentional you may want to use an AS0 ROA instead.',
        as0_redundant: 'Redundant ROA',
        redundant: 'Redundant ROA',
        too_permissive:
          'ROA permits extra announcements and may be abused for path spoofing hijacks',
        specific:
          'Allow specific announcement in a ROA which may be too permissive',
        new: 'New',
      },
    },
  ...
  announcements: {
    ...
    state: {
      ...
      roa_not_held_help:
        'The prefix is no longer on your certificate(s), the ROA will not be published',
      roa_no_announcement_info: 'NO ANNOUNCEMENT INFO',
      roa_too_permissive: 'TOO PERMISSIVE',
      roa_too_permissive_help:
        'This ROA matches announcements in BGP, but also allows unseen announcements',
      roa_disallowing: 'DISALLOWING',
      roa_disallowing_help:
        'This ROA disallows announcements only. If this is intentional you may want to use an AS0 ROA instead.',
      roa_redundant: 'REDUNDANT',
      roa_redundant_help:
        'This ROA is redundant because there are one or more other ROAs covering its prefix, length and ASN',
      roa_as0: 'AS0',
      roa_as0_help:
        'This ROA serves to disallow all announcements for a prefix',
      roa_as0_redundant: 'REDUNDANT',
      roa_as0_redundant_help:
        'This AS0 ROA is redundant because there are one or more other ROAs covering its prefix',
      ...
      announcement_invalid_length_help:
        'This announcement is not allowed because it is more specific than the prefix and max length you authorized for this ASN',
  ...
  errors: {
    ...
    pub_outside_jail:
      "Publisher uri '{uri}' outside repository uri '{sia_base}'",
    ...
    ca_parent_xml_duplicate:
      "This response is already used by a parent named '{parent}'",
    ...
    ca_child_resources_required:
      "You must specify resources for Child CA '{child}'",
    ca_roa_unknown:
      "Cannot remove unknown ROA '{prefix}-{max_length} => {asn}'",
    ca_roa_duplicate: "Duplicate ROA '{prefix}-{max_length} => {asn}'",
    ca_roa_invalid_max_length:
      "Invalid max length in ROA '{prefix}-{max_length} => {asn}'",
    ca_roa_not_entitled:
      "ROA prefix '{prefix}' is not on any of your current certificates",
    ta_not_allowed:
      'This functionality is not supported by the test Trust Anchor',
    ...
    api_auth_transient_error:
      'A (temporary) error occured while trying to authenticate your request. Please try again later.',
    api_auth_permanent_error:
      'An error occurred while trying to authenticate your request. Please contact your administrator.',
  ...
  testbed: {
    ...
    addChild: {
      ...
      confirmation: {
        title: 'Warning',
        message:
          'Are you sure you want to register this child with the testbed?',
      },
    ...
    removeChild: {
      ...
      confirmation: {
        title: 'Warning',
        message:
          'Are you sure you want to unregister this child with the testbed?',
      },
    ...
    addPublisher: {
      ...
      confirmation: {
        title: 'Warning',
        message:
          'Are you sure you want to register this publisher with the testbed?',
      },
    ...
    removePublisher: {
      ...
      confirmation: {
        title: 'Warning',
        message:
          'Are you sure you want to unregister this publisher with the testbed?',
      },
      success:
        "Publisher '{publisher_handle}' has been removed from the testbed.",
    },
    errors: {
      ...
      non_base64_certificate_xml_el:
        'Element {el} must contain a correctly Base64 encoded self-signed X.509 BPKI certificate',
      invalid_registration_data:
        'Your registration details could not be parsed correctly',
    },
  },
};
