    ...
    <tbody>
      {tableData.map((roa) => (
        <RoaTableRow
          ...
          allowDelete={roa.state === RoaState.RoaSeen || roa.state === RoaState.RoaDisallowing || roa.state === RoaState.RoaUnseen || roa.state === RoaState.RoaRedundant || roa.state === RoaState.RoaAs0Redundant || roa.state === RoaState.RoaTooPermissive || roa.state === RoaState.RoaNotHeld}
